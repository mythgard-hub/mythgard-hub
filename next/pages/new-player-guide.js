      ...
      >
        ...
        <div className="toc_column">
          ...
          <div className="articles_column">
            ...
            <p>
              Mythgard is a new CCG from Rhino Games that is freshly in Open
              Beta! It is an original property from a dedicated team of industry
              veterans passionate about making the CCG they always wanted to
              play themselves! Players will be able to immerse themselves in the
              lush artwork and story, following motorcycle riding Valkyries of
              Norden and Ved’ma witches of Dreni!{' '}
            </p>
            ...
            <p>
              ...
              . Rhino Games is currently focusing all efforts on rolling out
              Open Beta, but localization is on the roadmap for some point in
              the future and as the game grows, it may also expand to consoles!
            </p>
            ...
            <p>
              While many parts of Mythgard will feel familiar to experienced
              card game players, two features in particular deserve attention in
              getting started with the game: The resource system and the Game
              Board itself. Cards are sorted into one of six colors—Blue,
              Yellow, Red, Green, Orange, and Purple—and will have a cost
              represented with both Gems and Mana. Cards in hand can also be
              “burned” giving you one additional Mana and one additional Gem to
              spend each turn. Because of this flexible resource system, there
              are no dedicated resource cards and gameplay and deck design can
              more fluidly and smoothly evolve without having to worry about
              balancing resource cards. Cards can only be burned once and a
              burned card can be identified by the right-hand gem being broken.
              Upon being burned, a card is reinserted into the deck.. Mana can
              also be used to activate player Powers. Some Minions and Artifacts
              also have abilities that can be activated by paying a cost of
              Gems, Mana, or both.{' '}
            </p>
          </div>
          <img
          ...
          <div className="articles_column">
            <p>
              ...
              specific to this zone in Mythgard blocking is determined by
              position rather than keywords or phases of combat. The board
              itself is divided into 7 Lanes for each player, and minions must
              be played into one of these Lanes. Minions may attack into any of
              the three opposing lanes but may be required to first dispatch
              opposing minions before directly attacking the opponent. These
              Lanes can also host Enchantments, providing a variety of useful
              effects to minions which occupy the lane or the board itself.
              Effect on Minions range from simple bonuses to health or attack to
              granting special abilities to minions, and the Enchantments can
              nullify abilities on opposing minions or return Minions to play
              after being destroyed! The destruction of an occupying Minion does
              not remove Enchantments, so they can be used again by future
              Minions, though there are spells and effects which can destroy
              Enchantments.
            </p>
            ...
            <p>
              ...
              unoccupied lanes. Minions have a value for Strength and Health,
              and some have Awaken effects which trigger when they enter play or
              Demise effects which trigger when they enter the Boneyard.
              Strength value determines damage dealt in combat with other
              minions and the opponent. When a Minion’s Health is reduced to
              zero, it is sent to the Boneyard.
            </p>
            ...
            <p>
              <strong>Enchantments:</strong> A permanent effect which targets
              one of your seven lanes, providing bonuses to the occupying minion
              or imposing penalties on opposing minions.
            </p>

            <p>
              <strong>Artifacts:</strong> Cards which can provide both
              continuous and activated bonuses and effects for a Player while
              they are in play. A player may only have five Artifacts in play at
              one time. Many artifacts also have Durability, similar to a
              Minion’s Health. For each point of damage dealt directly to a
              player, the most recently played Artifact’s Durability is
              decreased by one. Artifacts with Durability reduced to zero are
              placed in the Boneyard.{' '}
            </p>

            <p>
              Cards are divided into six colors, each corresponding with a
              Faction within the Mythgard universe:{' '}
            </p>
          ...
          <div className="articles_column">
            <p>
              ...
              properties such as Durability. Check the in-game guide for more
              info on these additional properties.
            </p>
            ...
            <p>
              ...
              left as well as your current Gems. Used gems will appear greyed
              out. Resources are spent automatically as you choose to play cards
              and abilities, and any used resources will be restored at the
              start of your turn. You gain both Gems and Mana by burning cards
              in your hand.
            </p>
            ...
            <p>
              ...
              reinserted randomly into your deck, but are never placed directly
              on top. Burning a card will grant you 1 maximum Mana and 1 Gem of
              the card’s Faction. Faction is displayed on the colored strip
              which run through the middle of the card and Gem on the card’s
              right side. The ring around the mana cost in the upper-left corner
              also indicates a card’s Faction. Each card can only be burned
              once, once a card has been burned it will show the ring in the top
              left being broken as well as have a burned look around the edge of
              the card.
            </p>
          </div>
          <img
          ...
          <div className="articles_column">
            ...
            <p>
              ...
              the center of the Game Board. Any cards dragged to the center of
              the Game Board will highlight potential Lanes, Minions, Artifacts,
              or Players which can be targeted.
            </p>
            ...
            <p>
              ...
              threatens 3 Lanes at a time, the Lane directly opposite it and the
              2 adjacent lanes.
            </p>
          </div>
          <img
          ...
          <div className="articles_column">
            ...
            <p>
              ...
              want to attack with and available Lanes will be highlighted in
              red. Minions can only attack Lanes within their area of influence
              and normally must attack Minions before being able to attack an
              empty Lane. Several keywords can alter the way this area of
              influence works.{' '}
            </p>
            ...
            <p>
              ...
              your opponent directly, even while blocked by another minion.
              Agile also ignores blocking restrictions such as Defender and
              Lurker.
              <br />
              <br />
            ...
            <p>
              ...
              the Game Board once played. To move a Minion, click and drag from
              the Minion the same way you would attack with it. Lanes the Minion
              can move to will be highlighted in green. Minions cannot normally
              attack and move in the same turn and are normally bound to moving
              1 Lane to either side. Several keywords can alter how movement
              works.
            </p>
            ...
            <p>
              ...
              When a minion’s health is 0, it is placed in the Boneyard. If
              you’re unsure of the result of an attack, simply hover the attack
              without letting go of the attacker to be given a damage resolution
              preview. There are several keywords with can alter damage
              calculation in combat.
            </p>
            ...
            <p>
              ...
              <br />
              <strong>Fragile X:</strong>{' '}
              <em>“Increases damage taken by X.”</em>
              <br />
              ...
              <em>
                ...
                without it. If the Alpha Strike minion deals enough damage to
                kill a minion without Alpha Strike, the opposing minion will not
                get to strike in retaliation.”
              </em>
              <br />
              ...
              <em>
                “Frenzy grants one Frenzy Attack after the minion uses a
                Standard Action or a Rush Action to attack. Only one Frenzy
                Attack can be used per turn.”
              </em>
              <br />
              ...
              <em>
                “The controlling player gains life equal to combat damage
                dealt.”
              </em>
              <br />
            ...
            <p>
              ...
              <em>
                “Frenzy grants one Frenzy Attack after the minion uses a
                Standard Action or Rush Action to attack. Only one Frenzy Attack
            ...
            <p>
              ...
              <em>
                “Removed from the game without triggering Demise effects or
              ...
              <em>
                “Removed from the game when leaving play, going to a boneyard,
                or returning to a deck.”
              </em>
              <br />
            ...
            <p>
              ...
              looking at the medallion in the top right corner of the card.
              Rarity will dicated how often you find cards in packs and in
              Gauntlet/Arena game modes. There are deck building restrictions
              and crafting costs based on rarity as well, which we will cover in
              the Deck Building Rules section later.
            </p>
          ...
          <div className="articles_column">
            ...
            <p>
              ...
              well as view/copy your current featured decks. A deck must contain
              a minimum of 40 cards and can not contain more than 200.
            </p>
            ...
            <p>
              Essence is the crafting currency of Mythgard. Essence can be
              gained by unmaking cards you own and can be used to make cards you
              do not own. Cards of different rarities have different essence
              values associated with them. They are as follows:
            </p>

            <p>
              Commons: <strong>Unmake</strong> for <strong>10</strong> essence
              and cost <strong>50</strong> essence to <strong>make.</strong>
              <br />
              Uncommons: <strong>Unmake</strong> for <strong>20</strong> essence
              and cost <strong>100</strong> essence to <strong>make.</strong>
              <br />
              Rares: <strong>Unmake</strong> for <strong>100</strong> essence
              and cost <strong>500</strong> essence to <strong>make.</strong>
              <br />
            ...
            <p>
              ...
              earned as Maat Rewards. Wild Cards have a specific rarity, card
              set and Faction associated with them. A Wildcard can be used to
              craft a card of the corresponding rarity, Faction and set instead
              of its essence cost. They can also be unmade for essence at double
              the standard rate of their corresponding rarity.
            </p>

            <p>
              After you have completed the start of your journey through
              Mythgard, you will also be given 3 special missions. These
              missions reward you with a total of 2 Mythic and 2 Rare wildcards
              that aren’t locked to any specific Faction, allowing you to create
              any card of those rarities you wish.
            </p>
            ...
            <p>
              ...
              variety of ways simply by playing the game. The main use of Coins
              is buying packs of cards and entry into the Arena.
            </p>
            ...
            <p>
              ...
              real money in the game’s store. Mythril can be spent in-game on
              card packs, Arena entry and for upgrading cards you own into their
              Prestige versions.{' '}
            </p>
            ...
            <p>
              ...
              click the thumbs up button in the bottom right corner of the
              screen following the conclusion of a match. Maat rewards you with
              Wildcards and is a very important part of the economy. Remember to
              thumbs up for Maat if you had a good game against your opponent.
            </p>
            ...
            <p>
              ...
              Team Rankstar was not able to compile a full list of missions at
              the time of publication but will update this accordingly, as soon
              as we have a complete list of missions. Until then, be sure to
              check the Missions tab in-game to see your current missions.
              Mission coin values are not static and vary from 600 to 900.
            </p>
            ...
            <p>
              ...
              through Mythgard. Team Rankstar was not able to compile a full
              list of achievements at the time of publication but will update
              this accordingly, as soon as we have a complete list of
              achievements. Until then, be sure to check the Missions tab
              in-game to see your current achievement progress.
            </p>
            ...
            <p>
              Different game modes off differing amounts of coin as rewards.
              Note that winning games also gets you 1 card per win for your
              first 3 wins per day.
            </p>
            ...
            <p>
              ...
              found under the Missions tab. In order to unlock the Chest, you
              will need 5 Seals. Seals are a rare reward for winning any match.
              You can also earn a guaranteed seal for a perfect Gauntlet run.
              The Chest contains large sums of Coins, the average amount is
              around 2,400 but can go as high as 12,000.
            </p>
            ...
            <p>
              ...
              <br />
              <strong>100%</strong> chance to get a Seal for perfect gauntlet
              wins
            </p>
            ...
            <p>
              ...
              already own all Mythics but you can open additional copies of
              cards of other rarities.
            </p>

            <p>
              In addition to Mythics, you also have a small chance to replace
              any card in the pack with a Wildcard of the corresponding rarity
              or a Prestige card. Just over 14% of packs will upgrade one or
              more cards to Wildcards and the same is true of Prestige cards as
              well.
            </p>
            ...
            <p>
              While the primary entry into Arena is free with a cooldown, more
              on that below, you can always skip the cooldown period by paying
              1800 coins and starting a new Arena run. The coins are deposited
              in “escrow” which can be won by opponents or won from opponents in
            ...
            <p>
              ...
              themed enemies. Chapter One also contains the Tutorial which
              yields more coins than average and guarantees enough XP to unlock
            ...
            <p>
              Constructed play that matches you with other players outside of
              the Ranked ladder. Fun and weird decks are always welcome and it’s
              a great place to test and practice without worrying about losing
              any Ranked Points (RP).
            </p>
            ...
            <p>
              ...
              each Ladder–Bronze, Silver, Gold, and Mythril–brings you to the
              next division (i.e. Bronze 01 to Bronze 02). These divisions
              provide a soft floor within the ladder, first taking you to 0 RP
              in that division before moving down to the previous division.
              There are 10 divisions per Ladder.
            </p>
            ...
            <p>
              Just what it says on the tin! Two teams of two face off in a
              chaotic and exciting action-packed format. Players each have six
              Lanes of their own but share the middle Lane, allowing them to
              pass Minions back and forth. Players can similarly target the
              opponent directly opposite them or diagonal from them, or even
              target friendly minions on their partner’s Lanes.
            </p>
            ...
            <p>
              Casual constructed gameplay against AI opponents with no turn
              timer and the ability to suspend games and return to them later.
              Brawl games can be played while you are waiting to match with
              opponents in any of the other game mode’s queues, but like any
              matches against AI, award less XP than PvP games.
            </p>
            ...
            <p>
              ...
              highlighting interesting mechanics of Mythgard. Later puzzles,
              those which award 100 coins instead of 30, feature fiendishly
              clever board states which have lethal solutions for the most
              creative and crafty players!
            </p>
            ...
            <p>
              ...
              signalling in booster drafts, and allow you determine the colors
              you are building around and entry is completely free. AI opponents
              become increasingly challenging as you work your way through
              gauntlets of 5, 7, and finally 9 matches, only advancing if you
              win. While the prizes are the same as other PvE matches,
              completing gauntlets guarantee seals for unlocking the weekly
              chest and are guaranteed to unlock a Path or Power!
            </p>
            ...
            <p>
              ...
              game played. If you want to end your run early, you can pay a fee
              in coins to re-enter, at which point winning 5 of your 9 matches
              will return your invested coin. Unlike Gauntlet, you will play all
              9 matches every time and for every two matches you lose, you will
              be given a bonus draft to shore up your deck.
            </p>
            ...
            <p>
              ...
              guarantees certain cards will be added to your collection,
              including some handy rares like Misanthropia. The XP gain from the
              Story is exactly the amount needed to get you to level 6, at which
              point all game modes are unlocked, so it is a good way to invest
              some time early on.
            </p>
            ...
            <p>
              After finishing Story mode, you should try your chops at the
              Puzzle mode as a good way to earn some extra coin. Puzzles not
              your thing? We’ve got you covered. Puzzles are your thing but
              you’re stuck and want to read a hint without spoiling the whole
              puzzle? We’ve got you covered. Just want to watch a video for the
              solution? We’ve got you covered You can find the Team Rankstar
              Puzzle Guide (with video tutorials by Charm3r) here:
              <br />{' '}
              <a
            ...
            <p>
              As mentioned above, because each complete Gauntlet run guarantees
              an unlocked Path or Power, this is by FAR the fastest method for
              unlocking all of the various elements of deck building. The
              completely free format is fun, though the AI doesn’t have quite
              the same killer instinct as human opponents. This is also a great
              way to get more familiar with cards in the Core Set, as you will
              be able to see many of them as you go through drafts and get to
              test drive many different decks as you fill out your collection of
              Paths and Powers!{' '}
            </p>
